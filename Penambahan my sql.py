...
#         /* STYLE UNTUK TABEL HASIL LUAS YANG BISA DIGESER */
#         .results-container {
#             position: fixed;
#             top: 100px;
#             right: 20px;
...
#     <!-- CONTAINER UNTUK TABEL HASIL LUAS YANG BISA DIGESER -->
...
#         // FUNGSI UNTUK MENAMBAHKAN HASIL KE TABEL
#         function addAreaResult(result) {
#             areaResults.push(result);
#             updateResultsTable();
#         }
        
#         // FUNGSI UNTUK UPDATE TABEL HASIL
#         function updateResultsTable() {
#             const tbody = document.getElementById('resultsBody');
#             tbody.innerHTML = '';
            
#             if (areaResults.length === 0) {
#                 tbody.innerHTML = '<tr><td colspan=\"6\" class=\"no-results\">Belum ada hasil perhitungan</td></tr>';
#                 return;
#             }
...
#                     '<br>' +
#                     '<span class=\"utm-badge\">' + result.utm_zone + '</span>' +
#                     '</td>' +
#                     '<td>' +
